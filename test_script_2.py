...
async def main():
    ...
    questions = [
        "Can you check my previous order status and also recommend a camera under 2 lakhs that has a resolution above 20 megapixel? Oh and exclude Panasonic and Nikon from the camera search.",
        "I want to file a complaint about a delayed delivery, but first what is the official shipping policy and do you sell any noise cancelling headphones from Sony under 30000?",
        "Are there any smartwatches with OLED display, what is the EMI policy for it, and did I ever call support about EMI before?"
    ]

    print(f"==================================================")
    print(f"--- Starting TechMart AI EXTREME Edge Case Test ---")
